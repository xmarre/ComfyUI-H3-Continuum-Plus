...
_EXACT_PREFIX_FRESH_GAP_BODY = (
    "Continue the current shot and ongoing action naturally through this brief transition. "
    "Do not restart or repeat earlier speech, words, or events; only an utterance already in progress "
    "may finish naturally once. Do not introduce a new shot, reference image, or the next timed event early."
)
