...
def test_exact_native_masked_prefix_is_neutral_context_not_replayed_authored_content():
    ...
    # Keep the physical local clock. New generation starts at local 39/24 =
    # 1.625s, still inside the authored 7-8s lizard continuation. Do not shift
    # the suffix to local zero.
